...
def enter_data():
    ...
    if accepted=="Accepted":
        ...
        if firstname and lastname:
            ...
            tkinter.messagebox.showwarning(title="Bişey unutmuyormuyuz", message="Ad soyad lütfen")
    else:
        tkinter.messagebox.showwarning(title= "hadi ama", message="Kabul et")
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["Africa", "Yozgat", "Antarctica", "Çankırı", "Asia", "Çorum", "Europe", "North America", "Oceania", "South America"])
